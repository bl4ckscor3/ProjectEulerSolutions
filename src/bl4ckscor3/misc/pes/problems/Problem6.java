...
public class Problem6 implements IProblem
{
	...
	public void exe()
	{
		...
		System.out.println("The difference between the sum of the squares and the square of the sum of the first one hundred natural numbers is " + ((int)Math.pow(sosum, 2) - sosquare));
	}
