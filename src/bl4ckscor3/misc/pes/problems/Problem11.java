...
public class Problem11 implements IProblem
{
	...
	{
		int result = 0;
		int right; //left, up, and the other two diagonals can be ignored as they will automatically be calculated by these 4 directions
		int down;
		int diagonalDown;
		int diagonalUp;
		int[][] grid = {
		...
		{
			for(int j = 0; j < grid[i].length; j++) //loop through the columns
			{
				//set values so the >result check is securely executed
				right = -1;
				down = -1;
				diagonalDown = -1;
				diagonalUp = -1;
